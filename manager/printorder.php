...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="customeraccount">Customer</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <div class="receiptframe">
            ...
            <div class="row">
                <div class="col-sm-2">
                    <button style="width: 100%;" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addnewprint">New Print <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-patch-plus-fill" viewBox="0 0 16 16">
                            <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zM8.5 6v1.5H10a.5.5 0 0 1 0 1H8.5V10a.5.5 0 0 1-1 0V8.5H6a.5.5 0 0 1 0-1h1.5V6a.5.5 0 0 1 1 0z" />
                        </svg></button><br><br>
                    <button style="width: 100%;" class="btn btn-danger" onclick="window.location='logoutprocess'">Log out
                ...
                <div class="col-sm-10">
                    <div class="inframe">
                        <p style="color: white;"><strong>Incomplete print</strong></p>
